export default function Footer() {
  ...
  {/* 🔮 Purple-blue outer glow layer */}
  <div className="absolute w-[420px] h-[460px] bg-purple-500 rounded-full blur-[100px] opacity-30 z-0"></div>

  <div className="flex flex-col md:flex-row gap-6 max-w-5xl w-full relative z-10">
    {/* Why Sign In Card */}
    <div className="flex-1 bg-gradient-to-br from-[#1a1a2e]/60 to-[#16213e]/60 border border-purple-800 rounded-2xl p-8 backdrop-blur shadow-lg flex flex-col justify-between h-[400px] w-[350px]">
      <div>
